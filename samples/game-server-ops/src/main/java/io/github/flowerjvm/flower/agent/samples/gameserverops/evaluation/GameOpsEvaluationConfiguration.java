...
@ConditionalOnProperty(
        ...
        name = "enabled",
        havingValue = "true")
public class GameOpsEvaluationConfiguration {

    @Bean
    FlowAwaiter gameOpsEvaluationFlowAwaiter() {
    ...
    @ConditionalOnProperty(
            ...
            havingValue = "true",
            matchIfMissing = true)
    AgentModelGateway gameOpsEvaluationModelGateway(Clock sampleClock) {
        return new GameOpsEvaluationScriptedModelGateway(sampleClock);
    }
}
