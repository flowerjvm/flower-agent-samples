...
dependencies {
    ...
    implementation("io.github.flowerjvm:flower-agent-core:0.2.0")
    ...
    implementation("io.github.flowerjvm:flower-ai-harness-core:0.1.3")
    implementation("io.github.flowerjvm:flower-ai-harness-observability:0.1.3")
    implementation("io.github.flowerjvm:flower-ai-harness-validator-jackson:0.1.3")

    implementation("io.github.flowerjvm:flower-action-runtime-core:0.3.2")
    implementation("io.github.flowerjvm:flower-action-runtime-observability:0.3.2")
    implementation("io.github.flowerjvm:flower-evaluation:0.1.2")
    ...
    testImplementation("io.github.flowerjvm:flower-testkit:0.1.2")
